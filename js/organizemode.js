...
function organizeModeToggle(ev) {
	...
	// The message should only be shown if organize mode is active, the the message box is not already visible
	const messageBox = document.getElementById('message-box');
//	if (buttonClasses.contains('active') && !messageBox.classList.contains('visible')) 
